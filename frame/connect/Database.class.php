...
class Database {
    ...
    public function read($sql, $params=array(), $hash_key=NULL) {
    ...
    private function catchError($sth, $sql, $params) {
        ...
        if ($sql_state == '00000') {
            ...
            throw new \Frame\Exception\RetryException("{$sql} binds " . json_encode($params) . " failded with state code HY000 {$sql_state} {$error_code} {$error_message}");
        }
