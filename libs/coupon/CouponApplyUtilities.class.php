...
class CouponApplyUtilities {
    ...
    public static function batchGetShopCouponApply($shopIds, $user_id, $service = 'virus') {
        ...
        $clientObj = new \Libs\Serviceclient\Client();
        $result = $clientObj->call('coupon', 'coupon/batch_get_shop_coupon_apply', $params, array('method'=>'POST','timeout' => 1));
    ...
    public static function queryCouponApply($params, $cols = "*", $fromMaster = FALSE, $hashKey = NULL) {
        ...
        $clientObj = new \Libs\Serviceclient\Client();
        $result = $clientObj->call('coupon', 'coupon/query_coupon_apply', $queryParams, array('method'=>'POST','timeout' => 1));
    ...
    public static function getCouponApply($couponApplyCode) {
        ...
        $clientObj = new \Libs\Serviceclient\Client();
        $result = $clientObj->call('coupon', 'coupon/get_coupon_apply', $params, array('method'=>'POST','timeout' => 1));
